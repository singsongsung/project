...
<link rel='stylesheet' type='text/css' media='screen' href='../css/basketList.min.css'>
            ...
            <div class="content_inner">
				...
				<div class="bannerBox">
					<ul class="titleBanner">
						<li class="title">장바구니</li>
						<li class="desc">주문하실 상품을 선택해주세요.</li>
					</ul>
				</div>
					
					
					<table border="1" cellpadding="0" cellspacing="0" width="700" id="basketTable">
						<tr class="basketInfo">
							<th  width="100">번호</th>
							<th  width="200">제목</th>
							<th  width="150">저자</th>
						...
						<c:forEach items="${basketList}" var="basket">
							<tr class="list">
								<td>${basket.basketNum }</td>
								<td><a href="getBasket.ba?basketNum=${basket.basketNum}">
										${basket.basketBookTitle }</a></td>
								<td>${basket.basketBookWriter }</td>
								<td>${basket.basketBookAmount }</td>
								<td><fmt:formatNumber value="${(basket.basketBookPrice)*(basket.basketBookAmount) }" pattern="###,###,###"/></td>
