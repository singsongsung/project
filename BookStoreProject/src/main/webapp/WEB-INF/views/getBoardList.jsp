...
<body>
	 <div class="wrapper">
      <%@ include file="/WEB-INF/views/include/header.jsp" %>
	 	  <hr/>
	<center>
		<h3>${userName}님! 여기는 고객센터 게시판입니다.</h3>
		<hr/>
		...
		&lt; 이전&gt;<c:if test="${paging.startPage != 1 }">
